...
<body>
 <%@ include file="../form/header.jsp" %>
    ...
    <!--================start writing area =================-->
        <div>
            <form action="free.do" name="viewForm" method="post"  style="margin-bottom: 50px;">
                    ...
                    <div class="freeboard_detail" role="main">
                        ...
                        <div id="freeboard_form">
	                        ...
	                        <div style="text-align: right;">
	                            ...
	                            <button type="button" class="genric-btn primary radius" id="btnCancel" onclick="location.href='free.do?command=detail&no=${parentPost.postNo}'">취소</button>
	                        </div>
                        </div>
                    </div>
                </div>
