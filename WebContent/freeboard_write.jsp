    ...
    <!--================start writing area =================-->
        <div class="freeboard_detail" role="main">
            ...
            <div id="freeboard_form">
				<form action="free.do" name="writeForm" id="writeForm" role="form" method="post">
					...
					<div style="text-align:right;">
						...
						<input type="button" class="genric-btn primary radius" id="btnCancel" onclick="location.href='free.do?command=list'" value="취소">
		            </div>
				</form>
            </div>
		</div>
