...
CREATE TABLE MOIM_BOARD(
    ...
    MOIM_STATUS CHAR(1) CHECK(CLASS_STATUS IN('Y','N')),
    MOIM_PLACE VARCHAR2(500) NOT NULL,
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LAMBIC',
    '5.8',
    '바쿠스 올드 플레미쉬 브라운에 바탕을 두고 신맛과 단맛의 완벽한 조화는 핑크색 거품 폼으로 그 정점을 찍습니다.',
    '8. 바쿠스 체리 비어');
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'PILSNER',
    '5.1',
    '독일 맥주 순수령에 따른 정통 독일 필스너로 독일의 수도 베를린을 상징하는 메트로 폴리탄 맥주입니다. 투명한 황금빛의 경쾌한 탄산감. 홉의 쌉쌀함이 청량감을 부르는 클리색 베를린스타일 필스너로 베를린 수도 정도 750주년을 기념하는 맥주입니다.',
    '14. 베를리너 킨들 필스너');
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'PALELAGER',
    '5.0',
    '적당한 바디를 가지며, 풍미가 있고, 상쾌한 아메리칸 스타일 라거. 최상의 몰트와 프리미엄홉들을 섞어 양조됩니다.',
    '28. 버드와이저'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BELGIAN',
    '9.2',
    'ABV 9.2%의벨지안다크스트롱에일입니다. 카라멜, 탄산, 단맛, 거품등어느것도지나치치않게정리된맛입니다.',
    '41. 퀴베 클라리세'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BELGIAN',
    '11',
    '타의추종을 불허하는 꾸베두샤또카스틸은 카스틸맥주 중 단연 첫번째 자리를 차지합니다. 꾸베는 마치 카스틸동커를 10년 간 고성의 와인창고에 서숙성시킨듯 한 고급스럽고 강력한 향과 맛을 지니고 있습니다.',
    '42. 카스틸 꾸베 드 샤또'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BELGIAN',
    '8.5',
    '구리빛 생상과 홉의 풍성한 향으로 매우 청량하고 단 맛과 쓴 맛이 조화를 이루고 있다. 병입후 재발효가 지속적으로 이뤄짐으로 장기간 보관후 음용시 다른 차원의 복잡함을 느낄 수 있다.',
    '46. 듀퐁 모네트 블론드'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BELGIAN',
    '8.5',
    '풀바디감의 강렬한 수도원 맥주. 병입 재발효의 과일향과 몰트, 그리고 홉의 조화로움이 인상적인 맥주. 풀바디감의 부드럽게 느껴지는 파인애플, 복숭아 등의 과일향과 허브, 몰트, 마일드 홉, 그리고 벨기에 효모의 힌트가 매우 조화로운 풍미를 가지고 있습니다.',
    '50. 이나므 트리펠'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'WHEAT',
    '5.3',
    '한 모금마다 더 마시고 싶은 여운을 남깁니다. 에딩거 바이스 비어는 전통적인 바바리안 양조기술에 최상급 효모를 사용하여 만들어집니다.',
    '52. 에딩거 바이스비어'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LAMBIC',
    '8.0',
    '가장 훌륭한 3년 숙성을 선정하여 약간의 영 람빅과 블렌딩하여 생산합니다.라임과 귤같은 과일과 부드러운 바닐라, 약간의 타르트와 상쾌한 산미와 따뜻한 입안의 느낌이 조화를 이룹니다.',
    '64. 분 괴즈 마리아주 파르페'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'PALE',
    '5.5',
    '그리셋 블론드 바이오는 가볍고 상쾌한 페일에일입니다. 병주입 후 2차발효를 하였고 다른 맥주에서 볼 수 없는 풍부한 향기가 방출됩니다. 헤드는 부드럽고 흰색이며 바디는 짚색깔의 노란색입니다.',
    '67. 그리셋 블론드 바이오'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'WHEAT',
    '5.5',
    '독일맥주순수령에 따라 맥아, 홉, 물, 효모 만을 이용해 브류잉하고 필터링하지 않은 정통 독일식 밀맥주 헤페바이젠입니다. 바이젠 특유의 효모를 사용하여 바닐라향과 정향이 풍부하고, 입 안에서 느껴지는 부드럽고 풍부한 느낌이 즐거운 맥주입니다.',
    '77. 히타치노네스트 바이젠'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'PALE',
    '8.0',
    '카스틸루지는 카스틸 동커와 체리리큐르의 만남으로 흑 맥주를 바탕으로 뛰어난 부드러운 맛을 만들어 냅니다.',
    '85. 카스틸 루지'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LAMBIC',
    '3.0',
    '오크통에 체리 500KG을 사용해 천연의 향과 맛을 느낄 수 있는 맥주로 생과일의 특징이 가득해 과일주스를 마시는 듯한 느낌을 줍니다.',
    '88. 크릭람빅');
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'PILSNER',
    '5.0',
    '밝은 금빛 색상. 독일 스타일의 필스너. 후추, 풀, 곡물, 벌꿀 등의 풍미와 잔잔한 마무리',
    '92. 레이크 프런트 필스'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LIGHT',
    '4.7',
    '옅은 홉맛, 적절한 탄산과 함께 청량청량해서 목넘김 역시 좋았다 끝맛은 살짝 비린맛이 느껴지만 깔끔한편인 무난무난한 가볍게 마시기 괜찮은 맥주이다.',
    '94. 라오샨 맥주'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'PALELAGER',
    '4.6',
    '기분 좋은 청량감과 목 넘김이 좋은 깔금한 라거 맥주로 진한 맥아 향과 함께 기분 좋은 홉향을 즐길 수 있는 맥주이다.',
    '101. 롱보드 아일랜드 라거'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'DUNKEL',
    '7.1',
    '탄산감은 적기 때문에 청량한 터짐을 기대할 수 없고, 질감이나 무게감은 7.1%의 복(Bock)임을 감안했을 때, 좋게 말하면 순하고 마시기 편함.. 나쁘게 표현하자면 너무 평탄하고 밋밋하다는 느낌이 든다. 중간(Medium)수준의 무게감(Body)를 갖추었다.',
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LIGHT',
    '4.2',
    '엷은 황금색. 가볍고 달콤한 몰트 맛이 느껴지나, 과일 향이나 홉의 쓴맛은 별로없다. 탄산기가 높은 것이 특징이며 옥수수가 함유됐다.',
    '106. 밀러 라이트'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BELGIAN',
    '8.5',
    '4종의 스페셜 몰트의 혼합으로 밝은 다크브라운에서 적갈색사이의 특이한 색깔을 나타냅니다. 홉과 스페셜 몰트의 향이 뫼네트 브륀의 지배적인 풍미를 나타냅니다. 뫼네트 브륀은 약간의 쓴맛과 프루티함을 드러냅니다. 병입후 진행되는 재발효과정이 뫼네트 브륀을 놀라운 맥주로 바꿔줄 것입니다.',
    '107. 뫼네트 블론드'); 
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'STOUT',
    '5.8',
    '옥토버축제 기간에만 한정 생산되는 시즈널 맥주로 깔끔한 호프의 향취가 독특한 정통 바이에른 스타일 라거입니다. 전 세계 저온저장 하면발효라거 중 가장 고급재료인 독일 바이에른산 보리몰트와 할러타우 호프의 쌉쌀한 풍미와 조화로움을 느낄 수 있습니다.',
    '121. 웨팅어 페스트비어');    
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LAMBIC',
    '6.0',
    '람빅에 체리(크릭)을 넣어 발효시킨 전통 벨기에 람빅입니다. 달지않으며 펑키하고 새콤하 체리의 향이 매력적입니다. 리터당 400g이 넘는 체리를 씨앗째 사용하며 설탕이나 인공감미료, 보존제를 전혀 넣지않고 100% 전통방식으로 만들고 있습니다.',
    '124. 우드 크릭 비에유');    
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LAMBIC',
    '4.0',
    '체리를 담궈 6개월동안 숙성시킨 람빅 맥주에 진한 체리의 풍미와 아몬드 향을 만들어 냈습니다.',
    '165. 세인트루이스 크렉 람빅');  
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'LAMBIC',
    '3.2',
    '투명하고 산뜻한 붉은 빛의 세인트 루이스 프리미엄 크렉은 6개월간 숙성을 거쳐 오블라신스카체리의 달콤함과 아몬드향을 자랑합니다.',
    '166. 세인트루이스 프리미엄 크릭');  
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BLONDE',
    '7.0',
    '벨기에 블론드 에일에서 기대할 수 있는 단 향은 바나나, 배, 캔디, 시럽 등으로 나와주었다. 알싸한 정향, 후추 쪽은 살짝 있는 정도였고 아주 조금의 식물스러운 향기도 맡을 수 있었다.',
    '167. 세인트 마틴 블론드');  
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'ENGLISH',
    '6.5',
    '"작은 부엉이라는 뜻의 부엉이 맥주로 특별한 세가지 허브가 사용된 친환경 웰빙 에일맥주“',
    '168. 스티뉴이크');  
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'BELGIAN',
    '6.6',
    '트리포터 프롬 헬은 봄브루어리에서 만든 맥아를 사용한 어두운 맥주입니다. 초콜릿, 카라멜, 커피, 신선한 빵을 떠올리게 합니다. 밀맥아를 사용하여 외관이 약간 탁합니다. 병에서 숙성되며 계속 맛이 변화합니다.',
    '176. 트리포터 프롬 헬');  
...
VALUES(BEERSQ.NEXTVAL,
    ...
    'INDIA',
    '8.1',
    'SIMCOE홉에서는 열대포도의 맛과 향기를, COLUMBUS에서는 톡쏘 는강렬함을, CENTENNIAL에서는 소나무향이, 그리고 CITRA와 CASCADE를 추가함으로써 오묘한 향과 맛이 스며 나옵니다.',
    '189. 웨스트 코스트 IPA');  
...
VALUES(STORYSEQ.NEXTVAL,'진화한 혼술족 위한 편의점 맥주, 안주 궁합', 'http://www.donga.com/news/article/all/20200416/100690209/1');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '멕시코 코로나 맥주도 생산 중단', 'http://news.kbs.co.kr/news/view.do ncd=4416971&ref=A');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '수입맥주 배달 4캔 만원시대 개막', 'http://cnews.beyondpost.co.kr/view.php ud=20200410084840348546a9e4dd7f_30');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '효모로 맥주 대신 수소 만든다', 'http://amenews.kr/news/view.php idx=42049');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '칼로리가 낮은 맥주 TOP10', 'http://www.sommeliertimes.com/news/articleView.html idxno=16210');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '나인밀라 맥주효모 천연샴푸 선보여', 'http://www.dailygrid.net/news/articleView.html idxno=361687');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '무알코올 맥주, 알코올 정말 안 들었을까 ', 'http://health.chosun.com/site/data/html_dir/2020/02/25/2020022501431.html');

INSERT INTO BEER_STORY
VALUES(STORYSEQ.NEXTVAL, '수입맥주 40종, 수입와인 1종 모두 농약 성분 불검출', 'https://newsis.com/view/ id=NISX20190427_0000634177&cID=10201&pID=10200');
